...
![Map of global BIOCLIM Mean Diurnal Range with red points marking
Hawkweed occurrence
records.](reference/figures/README-occurrences-1.png)
...
![Global map of Range bagging SDM predicted climate suitability for
Hawkweed.](reference/figures/README-rangebag_model-1.png)
...
![Global map of Climatch SDM predicted climate suitability for
Hawkweed.](reference/figures/README-climatch_model-1.png)
...
(dissimilar) conditions. The
[`mess()`](https://cebra-analytics.github.io/bssdm/reference/mess.md)
function also returns the most dissimilar variable (MoD) and most
similar variable (MoS) for each location.
...
![Global map of MESS scores showing environmental similarity to Hawkweed
occurrence locations.](reference/figures/README-plot_mess-1.png)
...
![Global map of MESS most dissimilar variable (MoD) for each location
relative to Hawkweed occurrence
data.](reference/figures/README-plot_mess_mod-1.png)
...
function returns a score where values less than 0 indicate Type 1
novelty, values between 0 and 1 indicate analog conditions, and values
greater than 1 indicate Type 2 novelty.
...
![Global map of ExDet scores distinguishing Type 1 (univariate) and Type
2 (multivariate) environmental
novelty.](reference/figures/README-plot_exdet-1.png)
...
![Global map of the most influential covariate for Type 1 (univariate)
ExDet novelty.](reference/figures/README-plot_exdet_mic1-1.png)
...
![Global map of the most influential covariate for Type 2 (multivariate)
ExDet novelty.](reference/figures/README-plot_exdet_mic2-1.png)
