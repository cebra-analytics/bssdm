...
```{r occurrences, message = FALSE, fig.align = "center", fig.dim = c(12, 7)}
library(bssdm)
...
```{r rangebag_model, message = FALSE, fig.align = "center", fig.dim = c(12, 7)}
...
```{r climatch_model, message = FALSE, fig.align = "center", fig.dim = c(12, 7)}
# Run Climatch SDM
...
```{r plot_mess, message = FALSE, fig.align = "center", fig.dim = c(10, 6)}
plot(mess_output)
```

```{r plot_mess_mod, message = FALSE, fig.align = "center", fig.dim = c(12, 6)}
...
```{r plot_exdet, message = FALSE, fig.align = "center", fig.dim = c(10, 6)}
plot(exdet_output)
```

```{r plot_exdet_mic1, message = FALSE, fig.align = "center", fig.dim = c(12, 6)}
plot(exdet_output, which = "mic1")
```

```{r plot_exdet_mic2, message = FALSE, fig.align = "center", fig.dim = c(12, 6)}
