...
```{r occurrences, message = FALSE, fig.align = "center", fig.dim = c(12, 7), fig.alt = "Map of global BIOCLIM Mean Diurnal Range with red points marking Hawkweed occurrence records."}
library(bssdm)
...
```{r rangebag_model, message = FALSE, fig.align = "center", fig.dim = c(12, 7), fig.alt = "Global map of Range bagging SDM predicted climate suitability for Hawkweed."}
...
```{r climatch_model, message = FALSE, fig.align = "center", fig.dim = c(12, 7), fig.alt = "Global map of Climatch SDM predicted climate suitability for Hawkweed."}
# Run Climatch SDM
...
```{r plot_mess, message = FALSE, fig.align = "center", fig.dim = c(10, 6), fig.alt = "Global map of MESS scores showing environmental similarity to Hawkweed occurrence locations."}
plot(mess_output)
```

```{r plot_mess_mod, message = FALSE, fig.align = "center", fig.dim = c(12, 6), fig.alt = "Global map of MESS most dissimilar variable (MoD) for each location relative to Hawkweed occurrence data."}
...
```{r plot_exdet, message = FALSE, fig.align = "center", fig.dim = c(10, 6), fig.alt = "Global map of ExDet scores distinguishing Type 1 (univariate) and Type 2 (multivariate) environmental novelty."}
plot(exdet_output)
```

```{r plot_exdet_mic1, message = FALSE, fig.align = "center", fig.dim = c(12, 6), fig.alt = "Global map of the most influential covariate for Type 1 (univariate) ExDet novelty."}
plot(exdet_output, which = "mic1")
```

```{r plot_exdet_mic2, message = FALSE, fig.align = "center", fig.dim = c(12, 6), fig.alt = "Global map of the most influential covariate for Type 2 (multivariate) ExDet novelty."}
...
Drake, J. M. (2015). 'Range bagging: a new method for ecological niche modelling from presence-only data'. *Journal of the Royal Society Interface*, 12(107), 20150086. [doi:10.1098/rsif.2015.0086](https://doi.org/10.1098/rsif.2015.0086)

Elith, J., Kearney, M., and Phillips, S. (2010). 'The art of modelling range-shifting species'. *Methods in Ecology and Evolution*, 1, 330–342. [doi:10.1111/j.2041-210X.2010.00036.x](https://doi.org/10.1111/j.2041-210X.2010.00036.x)
...
GBIF.org (04 May 2026) 'GBIF Occurrence Download'. [doi:10.15468/dl.q6q6fk](https://doi.org/10.15468/dl.q6q6fk)

Mesgaran, M. B., Cousens, R. D., and Webber, B. L. (2014). 'Here be dragons: a tool for quantifying novelty due to covariate range and correlation change when projecting species distribution models'. *Diversity and Distributions*, 20(10), 1147–1159. [doi:10.1111/ddi.12209](https://doi.org/10.1111/ddi.12209)

Zizka, A., Silvestro, D., Andermann, T., Azevedo, J., Duarte Ritter, C., Edler, D., Farooq, H., Herdean, A., Ariza, M., Scharn, R., Svanteson, S., Wengstrom, N., Zizka, V., & Antonelli, A. (2019). 'CoordinateCleaner: standardized cleaning of occurrence records from biological collection databases.' *Methods in Ecology and Evolution*, 7. [doi:10.1111/2041-210X.13152](https://doi.org/10.1111/2041-210X.13152), R package version 3.0.1, <https://github.com/ropensci/CoordinateCleaner>.
