...
<!-- badges: start -->
[![Last commit](https://img.shields.io/github/last-commit/GlobalEcologyLab/poems.svg)](https://github.com/cebra-analytics/bssdm/commits/main)
<!-- badges: end -->
...
The SDM requires species occurrence records to be specified in a table with latitude and longitude coordinates using the WGS84 coordinate reference system. Here we will use global Hawkweed (*Hieracium pilosella*) occurrences downloaded from Global Biodiversity Information Facility (GBIF, 2026).
